...
function setupEventListeners() {
    setupReturnToMenuButton(); // Pour Coaching4
    ...
    setupRetourneMenueButton(); // Pour Coaching3
    debugLog("Event listeners configured");
}

// Configuration des sélecteurs de programme
...
// Configuration du bouton "Next" pour Coaching4
...
// Configuration du sélecteur de pompes
...
// Calcul des combinaisons de programme
...
// Configuration du bouton Go pour Coaching4
...
async function playInitialAudio() {
    if (currentAudioIndex < currentCombination.length && !isAudioPlaying) {
        ...
        // Jouer "Lastways" si c'est le dernier audio
...
function setupReturnToMenuButton() {
    ...
    if (returnButton) {
        returnButton.addEventListener('click', function() {
            ...
            console.log("UI reset, audio stopped, and all descriptions hidden for Coaching4.");
        });
    } else {
        console.log("Return to menu button not found for Coaching4.");
    }
}

function hideUIComponents() {
    const elementsToHide = [
        'pompesSelectorContainer', 'pompesInstruction', 'programSelect',
        'tapisImage', 'returnButton', 'audioDescription', 'videoDescription',
        'videoContainer', 'welcomeVideo'
    ];
